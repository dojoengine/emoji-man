...
export const snoise = (v) => {
  ...
  let i1 = math.min([[g[0], g[1], g[2]], [l[2], l[0], l[1]]], 0);
  let i2 = math.max([[g[0], g[1], g[2]], [l[2], l[0], l[1]]], 0);
  ...
  m = multiply(m, m);
  m = multiply(m, m);
  let noise = multiply(105.0, math.dot(m, [math.dot(p0,x0), math.dot(p1,x1), math.dot(p2,x2), math.dot(p3,x3)]));
  return noise;
}
